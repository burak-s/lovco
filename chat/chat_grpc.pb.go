...
type ChatServiceClient interface {
	...
	EndChatSession(ctx context.Context, in *EndChatRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *chatServiceClient) EndChatSession(ctx context.Context, in *EndChatRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type ChatServiceServer interface {
	...
	// To close chat session for user. if user owns leftover it deletes messages.
	EndChatSession(context.Context, *EndChatRequest) (*empty.Empty, error)
...
func (UnimplementedChatServiceServer) EndChatSession(context.Context, *EndChatRequest) (*empty.Empty, error) {
